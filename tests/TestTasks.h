...
private:
     ...
     * One inserted NOP
     * */
    bool testMultiThreadStall1(){
#ifndef NDEBUG

        Log::D(mName) << "Testing two tasks with stalling..." << std::endl;
     ...
     * One inserted NOP
     * */
    bool testMultiThreadStall2(){
#ifndef NDEBUG

        Log::D(mName) << "Testing three tasks with stalling..." << std::endl;
    ...
    bool doTest(){
        ...
        result &= testMultiThreadStall1();
        result &= testMultiThreadStall2();
